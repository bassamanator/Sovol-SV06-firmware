...
If you wanted to use the One-Stop-Shop Klipper Configuration with a different printer, please refer to the [any-printer](https://github.com/bassamanator/Sovol-SV06-firmware/tree/any-printer) branch.
